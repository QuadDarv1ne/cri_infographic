...
const zones: TemperatureZone[] = [
  {
    ...
    description: '~1000K — Тёплый свет пламени',
  },
  {
    minK: 2700,
    maxK: 3200,
    ...
    description: '2700–3200K — Уютный тёплый свет',
  },
  {
    minK: 4000,
    maxK: 5000,
    ...
    description: '4000–5000K — Естественный дневной свет',
  },
  {
    minK: 5600,
    maxK: 6500,
    ...
    description: '5600–6500K — Яркий холодный свет',
  },
  {
    minK: 10000,
    maxK: 20000,
